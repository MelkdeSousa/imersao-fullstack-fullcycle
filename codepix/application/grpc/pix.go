...
func (pix *PixGrpcService) RegisterPixKey(ctx context.Context, in *pb.PixKeyRegistration) (*pb.PixKeyCreatedResult, error) {
	key, err := pix.PixUseCase.RegisterKey(in.Key, in.Kind, in.AccountId)
...
func (pix *PixGrpcService) Find(ctx context.Context, in *pb.PixKey) (*pb.PixKeyInfo, error) {
	pixKey, err := pix.PixUseCase.FindKey(in.Key, in.Kind)
